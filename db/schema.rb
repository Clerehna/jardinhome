...
ActiveRecord::Schema[7.0].define(version: 2022_12_19_145705) do
  ...
  create_table "buyings", force: :cascade do |t|
    ...
    t.index ["prestation_id"], name: "index_buyings_on_prestation_id"
  ...
  add_foreign_key "buyings", "prestations"
